...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/MyProject/PHP/think_blog/Template/default/Admin/Public/css/login.css" />
</head>
<body>
<form class="form-group" action="<?php echo U('Admin/Login/index');?>" method="post">
	<div id="Login">
		<input class="form-control modal-sm" draggable="false" type="text" placeholder="后台登陆用户" name="username" >
		<br />
		<input class="form-control modal-sm" draggable="false" type="password" placeholder="后台登陆密码" name="password" value="<?php echo ($_SESSION['ADMIN_PASSWORD']); ?>">
		<br />
		<input class="form-control modal-sm" draggable="false" type="text" placeholder="验证码" autocomplete="off"  name="verify">
		<br />
