...
<form action="<?php echo U('Admin/Category/sort');?>" method="post">
    <table class="table table-bordered table-striped table-hover table-condensed">
        ...
        <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                ...
                <td>
                    <input class="form-control" type="text" name="<?php echo ($v['cid']); ?>" value="<?php echo ($v['csort']); ?>">
                </td>
                ...
                <td>
                    ...
                    <a href="javascript:if(confirm('确定要删除吗?')) location='<?php echo U('Admin/Category/del',array('cid'=>$v['cid']));?>'">删除</a>             
                </td>
