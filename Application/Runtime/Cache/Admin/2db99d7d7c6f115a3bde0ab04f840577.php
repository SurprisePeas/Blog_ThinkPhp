...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/MyProject/PHP/think_blog/Template/default/Home/Public/css/index.css">
        <link rel="stylesheet" href="/MyProject/PHP/think_blog/Public/static/iCheck-1.0.2/skins/all.css">
</head>
<body>
<form class="form-group" action="<?php echo U('Admin/Article/add');?>" method="post">
    <table class="table table-bordered table-striped table-hover table-condensed">
        <tr>
            ...
            <td>
                <select class="form-control modal-sm" name="category_cid">
        ...
        <tr>
            <th>描述</th>
            <td>
                <textarea class="form-control modal-sm" name="des" rows="7" placeholder="可以不填，如不填；则截取文章内容前300字为描述"></textarea>
            </td>
        </tr>
        <tr>
            <th>内容</th>
...
<script src="/MyProject/PHP/think_blog/Public/static/ueditor1_4_3/ueditor.config.js"></script>
<script src="/MyProject/PHP/think_blog/Public/static/ueditor1_4_3/ueditor.all.js"></script>
<script>
...
<!-- 百度统计结束 -->
<script src="/MyProject/PHP/think_blog/Public/static/iCheck-1.0.2/icheck.min.js"></script>
<script>
