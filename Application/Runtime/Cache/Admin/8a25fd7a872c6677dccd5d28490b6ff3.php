...
<form action="<?php echo U('Admin/Category/add');?>" method="post">
    <table class="table table-bordered table-hover">
        ...
        <tr>
            <th>排序</th>
            <td><input class="form-control modal-sm" type="text" value="80" name="csort" ></td>
        </tr>
        <tr>
            <th>关键词</th>
            <td><input class="form-control modal-sm" type="text" name="ckeywords" ></td>
        </tr>
        <tr>
            <th>描述</th>
            <td>
                <textarea class="form-control modal-sm" name="cdes"></textarea>
            </td>
        </tr>
        <tr>
            <th></th>
