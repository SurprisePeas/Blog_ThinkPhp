...
//*************************************网站设置****************************************
    ...
    'WEB_ICP_NUMBER'            =>  '旅途有好伴	不觉行程远',       // 网站ICP备案号
    'ADMIN_EMAIL'               =>  'surprisepeas@gmail.com',          // 站长邮箱

//*************************************优化推广****************************************
    'WEB_NAME'                  =>  'Goo博客',             //网站名：
    'WEB_KEYWORDS'              =>  'Goo,帅白,技术博客,个人博客,SurprisePeas',         //网站关键字
    'WEB_DESCRIPTION'           =>  'Goo的个人技术博客,SurprisePeas官方网站',      //网站描述
    'AUTHOR'                    =>  'Goo',               //默认作者
    'COPYRIGHT_WORD'            =>  '本文为Goo原创文章,转载无需和我联系,但请注明来自Goo博客',       //文章保留版权提示
    'IMAGE_TITLE_ALT_WORD'      =>  'Goo博客', //图片默认title和alt
